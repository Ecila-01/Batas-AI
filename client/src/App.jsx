        ...
        if (response.ok) {
          ...
          if (pastChats.length > 0) {
            ...
            pastChats.forEach(chat => {
              ...
              loadedMessages.push({ sender: 'ai', text: chat.answer, citations: ['Verified Document'] });
            });
      ...
      <main className="main-content">
        ...
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <a href="https://github.com/yourusername/batas" target="_blank" rel="noopener noreferrer" className="github-btn" title="View Source Code">
        ...
        <div className="chat-window">
            ...
            <div key={index} className={`message-wrapper ${msg.sender}`}>
              ...
              {msg.sender === 'ai' ? (
                 <div className="message-avatar ai">
                   {/* NATIVE MODERN SCALE ICON (Chat Bubble) */}
          ...
          {isLoading && (
            <div className="message-wrapper ai">
              <div className="message-avatar ai">
                 {/* NATIVE MODERN SCALE ICON (Loading state) */}
                 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                   <path d="M16 16c0 1.105-1.79 2-4 2s-4-.895-4-2" />
                   <path d="M12 2v16" />
                   <path d="M4 7h16" />
        ...
        <footer className="input-area">
          <form onSubmit={handleAsk} className="input-form">
            <input
              type="text"
              placeholder="Ask a question about the loaded ordinances..."
              value={input}
